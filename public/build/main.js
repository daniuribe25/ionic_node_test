...
var Reviews = (function () {
    ...
    Reviews.prototype.getReviews = function () {
        ...
        return new Promise(function (resolve) {
            _this.http.get('http://ec2-34-226-83-226.compute-1.amazonaws.com:8080/api/reviews')
    ...
    Reviews.prototype.createReview = function (review) {
        ...
        console.log(review);
        this.http.post('http://ec2-34-226-83-226.compute-1.amazonaws.com:8080/api/reviews', JSON.stringify(review), { headers: headers })
            .subscribe(function (res) {
            console.log(res.json());
        });
    };
    Reviews.prototype.deleteReview = function (reviewId) {
        this.http.delete('http://ec2-34-226-83-226.compute-1.amazonaws.com:8080/api/reviews/' + reviewId).subscribe(function (res) {
...
var AboutPage = (function () {
    ...
    AboutPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["u" /* Component */])({
            selector: 'page-about',template:/*ion-inline-start:"C:\Users\duribe\Desktop\AppNodeIonic\nodeionic\src\pages\about\about.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      About\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\nDamniel\n</ion-content>\n'/*ion-inline-end:"C:\Users\duribe\Desktop\AppNodeIonic\nodeionic\src\pages\about\about.html"*/
        }), 
...
var TabsPage = (function () {
    ...
    TabsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["u" /* Component */])({template:/*ion-inline-start:"C:\Users\duribe\Desktop\AppNodeIonic\nodeionic\src\pages\tabs\tabs.html"*/'<ion-tabs>\n  <ion-tab [root]="tab1Root" tabTitle="Home" tabIcon="home"></ion-tab>\n  <ion-tab [root]="tab2Root" tabTitle="About" tabIcon="information-circle"></ion-tab>\n  <ion-tab [root]="tab3Root" tabTitle="Contact" tabIcon="contacts"></ion-tab>\n</ion-tabs>\n'/*ion-inline-end:"C:\Users\duribe\Desktop\AppNodeIonic\nodeionic\src\pages\tabs\tabs.html"*/
        }), 
...
var LoginPage = (function () {
    ...
    LoginPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["u" /* Component */])({
            selector: 'page-login',template:/*ion-inline-start:"C:\Users\duribe\Desktop\AppNodeIonic\nodeionic\src\pages\login\login.html"*/'<ion-header>\n    <ion-navbar transparent>\n     <ion-title>\n       Review King\n     </ion-title>\n     <ion-buttons end>\n       <button ion-button icon-only (click)="addReview()"><ion-icon name="add"></ion-icon></button>\n     </ion-buttons>\n    </ion-navbar>\n   </ion-header>\n    \n   <ion-content>\n    \n     <ion-list no-lines>\n    \n       <ion-item-sliding *ngFor="let review of reviews">\n    \n         <ion-item>\n    \n           <ion-avatar item-left>\n             <img src="https://api.adorable.io/avatars/75/{{review.title}}">\n           </ion-avatar>\n    \n           <h2>{{review.title}}</h2>\n           <p>{{review.description}}</p>\n    \n           <ion-icon *ngIf="review.rating < 50" danger name="sad"></ion-icon>\n           <ion-icon *ngIf="review.rating >= 50" secondary name="happy"></ion-icon>\n           {{review.rating}}\n    \n         </ion-item>\n    \n         <ion-item-options>\n           <button ion-button color="danger" (click)="deleteReview(review)">\n             <ion-icon name="trash"></ion-icon>\n             Delete\n           </button>\n         </ion-item-options>\n       </ion-item-sliding>\n    \n     </ion-list>\n    \n   </ion-content>'/*ion-inline-end:"C:\Users\duribe\Desktop\AppNodeIonic\nodeionic\src\pages\login\login.html"*/,
